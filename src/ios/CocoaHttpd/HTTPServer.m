...
- (void)sendIncomingConnectionInfo:(NSMutableDictionary *)incommingConnInfo
{
    CDVPluginResult *pluginResult;
    
    if(incommingConnInfo != nil)
    {
        pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsDictionary:incommingConnInfo];
        [pluginResult setKeepCallbackAsBool:true];
    }
    else
    {
        pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"Unable to retrive incoming connection information"];
        [pluginResult setKeepCallbackAsBool:true];
    }
